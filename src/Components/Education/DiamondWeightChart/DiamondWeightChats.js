...
export default function DiamondWeightChats() {
  window.scrollTo(0, 0);
          ...
          <>
            <Col md={4}>
              <Table>
                <thead>
                  <tr>
                    <th>{selectedShape} MM Size</th>
                    <th>{selectedShape} Carat Weight</th>
                  </tr>
                </thead>
                <tbody>
                  {dataItem?.map(item => {
      ...
      <section className="education_diamond_wrap pb100 pb50-md pb80-lg">
        <Container>
          <div className="diamond_detial_box">
            <h4 class="text_primary mb30">Diamond MM to Carat Weight Chats</h4>
            ...
            <div className="size_table_wrapper">
              <h5 className="text-center mt30 mb20">
