...
export default function CaringForLabGrownJewelry() {
  window.scrollTo(0, 0);
  return (
    <main>
      <section className="education_diamond_wrap pb100 pb50-md pb80-lg">
        <Container>
          <div className="diamond_detial_box">
            ...
            <h6>Store with Care In Right Box</h6>
            <ul>
              <li>
            ...
            <h6>Regular Inspections Of Your Jewellery</h6>
            <ul>
              <li>
            ...
            <h6>Gentle Polishing With Time</h6>
            <ul>
              <li>
