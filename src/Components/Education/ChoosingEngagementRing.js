...
export default function ChoosingEngagementRing() {
  window.scrollTo(0, 0);
  return (
    <main>
      <section className="education_diamond_wrap pb100 pb50-md pb80-lg">
        <Container>
          <div className="diamond_detial_box">
            <h4 class="text_primary">Choosing the Perfect Engagement Ring</h4>
            <ul>
              <li>
            ...
            <h6>Know More About Diamonds 4Cs</h6>
            <ul>
              <li>
            ...
            <h6>Identify Your Partner's Style/Choice</h6>
            <ul>
              <li>
            ...
            <h6>Explore Different Diamond Shapes</h6>
            <ul>
              <li>
            ...
            <h6>Decide the Setting Style</h6>
            <ul>
              <li>
            ...
            <h6>Keep in Mind the Wedding Band Planning</h6>
            <ul>
              <li>
